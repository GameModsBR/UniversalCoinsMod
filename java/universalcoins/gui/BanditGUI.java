...
public class BanditGUI extends GuiContainer {
	...
	public void initGui() {
		super.initGui();
		spinButton = new GuiSlimButton(idPullButton, 130 + (width - xSize) / 2, 30 + (height - ySize) / 2, 32, 12,
				StatCollector.translateToLocal("general.button.spin"));
		coinButton = new GuiSlimButton(idCoinButton, 130 + (width - xSize) / 2, 45 + (height - ySize) / 2, 32, 12,
